...
parser.add_argument('--random_seed', default=1993, type=int, \
    help='random seed')
parser.add_argument('--datadir', default='/home/dataSet/MyImagenet/', type=str)
...
parser.add_argument('--ckp_prefix', default=os.path.basename(sys.argv[0])[:-3], type=str, \
    help='checkpoint_atten2_step_5_2000 prefix')
...
parser.add_argument('--resume', action='store_true', \
    help='resume from checkpoint_atten2_step_5_2000')
...
for iteration_total in range(args.nb_runs):
    ...
    order_name = "./checkpoint_atten2_step_5_2000/seed_{}_{}_order_run_{}.pkl".format(args.random_seed, args.dataset, iteration_total)
    ...
    for iteration in range(start_iter, int(args.num_classes/args.nb_cl)):
        ...
        ckp_path = './checkpoint_atten2_step_5_2000/{}'.format(args.ckp_prefix)
        ...
        if args.resume and os.path.exists(ckp_name):
            print("###############################")
            print("Loading models from checkpoint_atten2_step_5_2000")
            if iteration > start_iter:
                ...
                if args.less_forget:
                    ...
                    if args.mimic_score:
                        ...
                        tg_model = incremental_train_and_eval(args.epochs, tg_model, ref_model, tg_optimizer, tg_lr_scheduler, \
                            ...
                            iteration, start_iter,
                            args.T, args.beta) 
            if not os.path.isdir('checkpoint_atten2_step_5_2000'):
                os.mkdir('checkpoint_atten2_step_5_2000')
        ...
        cm_name = './checkpoint_atten2_step_5_2000/run_{}_iteration_{}_confusion_matrix.pth'.format(iteration_total, iteration)
